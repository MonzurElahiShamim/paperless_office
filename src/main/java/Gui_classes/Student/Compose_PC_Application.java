 ...
 */
public class Compose_PC_Application extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        progSkills = new javax.swing.JTextArea();
        jLabel10 = new javax.swing.JLabel();
        jLabel11 = new javax.swing.JLabel();
        jLabel12 = new javax.swing.JLabel();
        jLabel13 = new javax.swing.JLabel();
        grade1105 = new javax.swing.JTextField();
        grade1205 = new javax.swing.JTextField();
        grade2103 = new javax.swing.JTextField();
        jLabel14 = new javax.swing.JLabel();
        grade2105 = new javax.swing.JTextField();
        jLabel15 = new javax.swing.JLabel();
        grade2201 = new javax.swing.JTextField();
        jLabel16 = new javax.swing.JLabel();
        grade2205 = new javax.swing.JTextField();
        jLabel17 = new javax.swing.JLabel();
        jScrollPane5 = new javax.swing.JScrollPane();
        otherSkills = new javax.swing.JTextArea();
        ...
        expProgContest = new javax.swing.JTextArea();
        ...
        jLabel2.setText("ICE  Programming Club Committee Member Selection");
        ...
        motivation.setAutoscrolls(false);
        ...
        jLabel9.setText("Programming Skills (learned languages)");

        progSkills.setColumns(20);
        progSkills.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        progSkills.setLineWrap(true);
        progSkills.setRows(2);
        progSkills.setWrapStyleWord(true);
        progSkills.setAutoscrolls(false);
        progSkills.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                progSkillsKeyTyped(evt);
            }
        });
        jScrollPane4.setViewportView(progSkills);

        jLabel10.setFont(new java.awt.Font("MS Reference Sans Serif", 1, 12)); // NOI18N
        jLabel10.setText("Results in Programming Courses:");

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel11.setText("ICE-1105:");

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel12.setText("ICE-1205:");

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel13.setText("ICE-2103:");

        grade1105.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N

        grade1205.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N

        grade2103.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N

        jLabel14.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel14.setText("ICE-2105:");

        grade2105.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N

        jLabel15.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel15.setText("ICE-2201:");

        grade2201.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel16.setText("ICE-2205:");

        grade2205.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N

        jLabel17.setFont(new java.awt.Font("MS Reference Sans Serif", 1, 12)); // NOI18N
        jLabel17.setText("Other Skills:");

        otherSkills.setColumns(20);
        otherSkills.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        otherSkills.setLineWrap(true);
        otherSkills.setRows(4);
        otherSkills.setWrapStyleWord(true);
        otherSkills.setAutoscrolls(false);
        otherSkills.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                otherSkillsKeyTyped(evt);
            }
        });
        jScrollPane5.setViewportView(otherSkills);
        ...
        expProgContest.setColumns(20);
        expProgContest.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        expProgContest.setLineWrap(true);
        expProgContest.setRows(5);
        expProgContest.setWrapStyleWord(true);
        expProgContest.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                expProgContestKeyTyped(evt);
            }
        });
        jScrollPane9.setViewportView(expProgContest);

        jLabel21.setFont(new java.awt.Font("MS Reference Sans Serif", 1, 12)); // NOI18N
        jLabel21.setText("Experience in Programming contests:");
                        ...
                        .addGroup(applicationFormLayout.createSequentialGroup()
                            ...
                            .addGroup(applicationFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(applicationFormLayout.createSequentialGroup()
                                    ...
                                    .addComponent(grade2105, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(106, 106, 106)
                                    .addComponent(jLabel15)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(grade2201, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(111, 111, 111)
                                    .addComponent(jLabel16)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(grade2205, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(applicationFormLayout.createSequentialGroup()
                                    .addComponent(jLabel11)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(grade1105, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(106, 106, 106)
                                    .addComponent(jLabel12)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(grade1205, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(111, 111, 111)
                                    .addComponent(jLabel13)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(grade2103, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGroup(applicationFormLayout.createSequentialGroup()
                            .addGap(352, 352, 352)
        ...
        applicationFormLayout.setVerticalGroup(
            ...
            .addGroup(applicationFormLayout.createSequentialGroup()
                ...
                .addGroup(applicationFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel12)
                    .addComponent(jLabel13)
                    .addComponent(grade1105, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(grade1205, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(grade2103, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(applicationFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
                    .addComponent(jLabel15)
                    .addComponent(jLabel16)
                    .addComponent(grade2105, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(grade2201, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(grade2205, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(jLabel17)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void submitBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitBtnMouseClicked
		...
		//Document save path
		String savePath = "PDFs/Student_Application/Programming_Club_Application_" + userName + ".pdf";
    ...
    private void motivationKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_motivationKeyTyped
		Utility.setMaxInputLength(motivation, evt, 385);
    ...
    private void causeKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_causeKeyTyped
		Utility.setMaxInputLength(cause, evt, 385);

    }//GEN-LAST:event_causeKeyTyped

    private void progSkillsKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_progSkillsKeyTyped
		// TODO add your handling code here:
		Utility.setMaxInputLength(progSkills, evt, 160);
    }//GEN-LAST:event_progSkillsKeyTyped

    private void otherSkillsKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_otherSkillsKeyTyped
		// TODO add your handling code here:
		Utility.setMaxInputLength(otherSkills, evt, 320);
    }//GEN-LAST:event_otherSkillsKeyTyped

    private void extraCurrKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_extraCurrKeyTyped
		// TODO add your handling code here:
		Utility.setMaxInputLength(extraCurr, evt, 385);
    ...
    private void expProgContestKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_expProgContestKeyTyped
        // TODO add your handling code here:
		Utility.setMaxInputLength(expProgContest, evt, 450);
    }//GEN-LAST:event_expProgContestKeyTyped

    private void goalFuturePlanKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_goalFuturePlanKeyTyped
        // TODO add your handling code here:
		Utility.setMaxInputLength(goalFuturePlan, evt, 600);
	...
	public static void main(String args[]) throws IOException, Exception {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Compose_PC_Application.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                }
				...
				new Compose_PC_Application().setVisible(true);
			}
		});
	}
    ...
    private javax.swing.JTextArea expProgContest;
    ...
    private javax.swing.JTextField grade1105;
    private javax.swing.JTextField grade1205;
    private javax.swing.JTextField grade2103;
    private javax.swing.JTextField grade2105;
    private javax.swing.JTextField grade2201;
    private javax.swing.JTextField grade2205;
    ...
    private javax.swing.JTextArea otherSkills;
    private javax.swing.JTextField postName;
    private javax.swing.JButton previewBtn;
    private javax.swing.JTextArea progSkills;
    private javax.swing.JButton submitBtn;
    // End of variables declaration//GEN-END:variables

	private String createPdf() {
		String fileName = "temp/Programming Club Application.pdf";
		int EnFontSize = 9;
		...
		try {
			...
			PDFWithImages.addLine(document, page, leftMargin + 50, yPos -= 20, 13, "ICE Programming Club Committee Member Selection", 'b');
			...
			PDFWithImages.drawRect(document, page, leftMargin, yPos, rightMargin, yPos - 105, lineThickness); // Draws a rectangle for response
			...
			yPos = 410;
			PDFWithImages.addLine(document, page, leftMargin - 3, yPos, 10, "Programming Skills (learned languages): ", 'b');
			PDFWithImages.drawRect(document, page, leftMargin, yPos, rightMargin, yPos - 45, lineThickness); // Draws a rectangle for response
			PDFWithImages.addParagraph(document, page, leftMargin + 5, yPos -= 20, 10, progSkills.getText());

			yPos = 330;
			PDFWithImages.addLine(document, page, leftMargin - 3, yPos, 10, "Result in Programming Courses:", 'b');
			PDFWithImages.drawLine(document, page, leftMargin, yPos, rightMargin, yPos, lineThickness); // Draws a Line Under heading
			PDFWithImages.addLine(document, page, leftMargin + 30, yPos -= 25, 9, "ICE-1105: " + grade1105.getText(), 'b');
			PDFWithImages.addLine(document, page, leftMargin + 205, yPos, 9, "ICE-1205: " + grade1205.getText(), 'b');
			PDFWithImages.addLine(document, page, leftMargin + 380, yPos, 9, "ICE-2103: " + grade2103.getText(), 'b');
			PDFWithImages.addLine(document, page, leftMargin + 30, yPos -= 20, 9, "ICE-2105: " + grade2105.getText(), 'b');
			PDFWithImages.addLine(document, page, leftMargin + 205, yPos, 9, "ICE-2201: " + grade2201.getText(), 'b');
			PDFWithImages.addLine(document, page, leftMargin + 380, yPos, 9, "ICE-2205: " + grade2205.getText(), 'b');

			yPos = 255;
			PDFWithImages.addLine(document, page, leftMargin - 3, yPos, 10, "Other Skills: ", 'b');
			PDFWithImages.drawRect(document, page, leftMargin, yPos, rightMargin, yPos - 85, lineThickness); // Draws a rectangle for response
			PDFWithImages.addParagraph(document, page, leftMargin + 5, yPos -= 20, 10, otherSkills.getText());
			...
			yPos = 470;
			PDFWithImages.addLine(document, page2, leftMargin - 3, yPos -= 10, 10, "Experience in Programming Contests: ", 'b');
			PDFWithImages.drawRect(document, page2, leftMargin, yPos, rightMargin, yPos - 125, lineThickness); // Draws a rectangle for response
			yPos = PDFWithImages.addParagraph(document, page2, leftMargin + 5, yPos -= 20, 10, expProgContest.getText());

			yPos = 315;
			PDFWithImages.addLine(document, page2, leftMargin - 3, yPos -= 10, 10, "Your Goals and Future-Plans to reach those goals: ", 'b');
			PDFWithImages.drawRect(document, page2, leftMargin, yPos, rightMargin, yPos - 165, lineThickness); // Draws a rectangle for response
			...
			Logger.getLogger(Compose_PC_Application.class.getName()).log(Level.SEVERE, null, ex);
		} catch (Exception ex) {
			Logger.getLogger(Compose_PC_Application.class.getName()).log(Level.SEVERE, null, ex);
