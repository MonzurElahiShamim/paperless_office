...
public class ComposeProttoyon extends javax.swing.JFrame {
	...
	@SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Application for Prottoyonpotro", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe Script", 1, 18))); // NOI18N
    ...
    private void applyBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_applyBtnMouseClicked
	    try {
		    ...
		    String body = "সবিনয় নিবেদন এই যে, আমি, " + stNameBn + ", আপনার ডিপার্টমেন্টের সেশন-" + session + ", বর্ষ-"
			    ...
			    + "প্রত্যয়নপত্র প্রয়োজন। নিম্নে আমার প্রয়োজনীয় তথ্যাবলী প্রদান করা হলো। অতএব জনাবের নিকট আকুল "
			    + "আবেদন এই যে, আমাকে উল্লেখিত প্রত্যয়নপত্র প্রদান করে বাধিত করবেন।";
		    ...
		    Logger.getLogger(ComposeProttoyon.class.getName()).log(Level.SEVERE, null, ex);
	    } catch (Exception ex) {
		    Logger.getLogger(ComposeProttoyon.class.getName()).log(Level.SEVERE, null, ex);
	    }
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ComposeProttoyon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                }
				new ComposeProttoyon().setVisible(true);
			}
		});
	}
