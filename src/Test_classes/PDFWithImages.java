...
public class PDFWithImages {
	...
	public static void main(String[] args) throws Exception {
		try {
			...
			addParagraph(document, page, 600, textPara);
	...
	public static void drawLine(PDDocument document, PDPage page, int x1, int y1, int x2, int y2) throws IOException {
		float thickness = 1.0f;
		drawLine(document, page, x1, y1,  x2, y2, Color.BLACK, thickness);
	}
	public static void drawLine(PDDocument document, PDPage page, int x1, int y1, int x2, int y2, float thickness) throws IOException {
		Color color = Color.BLACK;
		drawLine(document, page, x1, y1,  x2, y2, color, thickness);
	}
